...
<!-- Id Field -->
<div class="form-group row col-md-4 col-sm-12">
    {!! Form::label('salon', trans('lang.salon'), ['class' => 'col-4 control-label']) !!}
    <div class="col-8">
        @if(isset($booking->eserviceBookings[0]))
            <p>{!! $booking->eserviceBookings[0]->eservice->salon->name !!}</p>
        @endif
    </div>

    {!! Form::label('salon_address', trans('lang.salon_address'), ['class' => 'col-4 control-label']) !!}
    <div class="col-8">
        @if(isset($booking->eserviceBookings[0]))
            <p>{!! $booking->eserviceBookings[0]->eservice->salon->address !!}</p>
        @endif
    </div>

    {!! Form::label('salon_phone', trans('lang.salon_phone'), ['class' => 'col-4 control-label']) !!}
    <div class="col-8">
        @if(isset($booking->eserviceBookings[0]))
            <p>{!! $booking->eserviceBookings[0]->eservice->salon->phone !!}</p>
        @endif
    </div>
