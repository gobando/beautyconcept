                        ...
                        @foreach($booking->e_services as $eService)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex flex-column mx-3">
                                    <b>{{$eService->name}}</b> <small>{{__('lang.by')}} {{$booking->salon->name}}</small>
                                </div>
                                <div class="text-bold ml-xl-auto my-1 my-xl-0">
                                    @if($eService->hasDiscount())
                                        <del class="text-gray">{!! getPrice($eService->price) !!}</del>
                                    @endif
                                    <span class="h5 text-bold">{!! getPrice($eService->getPrice()) !!}</span>
                                </div>
                            </li>
                        @endforeach
                        <li class="list-group-item bg-light">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body px-0 py-1">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <b>{{__('lang.e_service_duration')}}</b><small>{{$booking->getDurationInHours()}} {{__('lang.booking_hours')}}</small>
                        </li>
                    </ul>
                </div>
            </div>
